...
fn main() {
    ...
    let tools_dir = Path::new(&manifest_dir).join("src").join("tools").join("exectools");
...
// Add/remove files in src-tauri/src/skills/ or src-tauri/src/tools/exectools/ and rebuild.
